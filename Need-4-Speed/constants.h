...
struct Constants {
    ...
    // CAR ATTACHMENTS POSITIONS
    inline static QVector<QPoint> window = {QPoint(48, 0), QPoint(68, -14), QPoint(105, -14), QPoint(112, -1), QPoint(110, 0)};
    inline static  QVector<QPoint> handle = {QPoint(96, 10), QPoint(102, 10), QPoint(102, 13), QPoint(96, 13)};


    // CAR BODY POINTS
    inline static QVector<QPoint> bodyPoints = {QPoint(0,0), QPoint(0,31), QPoint(9,37), QPoint(15,19), QPoint(44,19), QPoint(50,37), QPoint(138,37), QPoint(144,19), QPoint(172,19), QPoint(179,37), QPoint(188,31), QPoint(181,6), QPoint(137,0), QPoint(112,-25), QPoint(62,-25), QPoint(37,-6), QPoint(25,-7), QPoint(19,-19), QPoint(4,-21), QPoint(1,-15), QPoint(12, -10)};
    inline static QVector<QPoint> hitboxPoints = QVector<QPoint>{QPoint(15,6), QPoint(173, 1),  QPoint(137,0), QPoint(112,-25), QPoint(62,-25), QPoint(37,-6), QPoint(25,-7), QPoint(19,-19), QPoint(4,-21), QPoint(1,-15), QPoint(12, -10)};
    inline static QVector<QPoint> killPoints = QVector<QPoint>{QPoint(112, -25), QPoint(62, -25)};
    ...
    static constexpr QColor WINDOW_COLOR = QColor(120,170,220);
    static constexpr QColor HANDLE_COLOR = QColor(20,20,24);
    ...
    inline static QVector<QColor> FLIP_COLOR = {QColor(255,0,0), QColor(255,0,0), QColor(255,0,0), QColor(237,181,37), QColor(255,0,0)};
};
