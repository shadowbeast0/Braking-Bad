...
public class MainWindow {
    ...
    public MainWindow() {
            ...
            public void paint(Graphics g) {
                ...
                for (Wheel wheel : wheels) {
                    ...
                    if (coords != null) {
                        ...
                        int r = coords[2];
                        g2d.fillOval(coords[0] - r, coords[1] - r, r * 2, r * 2);
                    }
                }

                if (car != null) {
                    car.draw(g2d, camerax, cameray);
                }
            }
        };
        ...
        inputMap.put(KeyStroke.getKeyStroke("D"), "dPressed");
        ...
        inputMap.put(KeyStroke.getKeyStroke("A"), "aPressed");
        ...
        int r = 20;
        Wheel backWheel  = new Wheel(100, 300, r);
        int worldBase = (int)Math.round(Car.IMG_WHEEL_BASE * (r / Car.IMG_WHEEL_RADIUS));
        Wheel frontWheel = new Wheel(100 + worldBase, 300, r);
        backWheel.attach(frontWheel);
        wheels.add(backWheel);
        wheels.add(frontWheel);

        car = new Car(backWheel, frontWheel);
    ...
    public void show(){
        ...
        timer.schedule(new TimerTask(){
            ...
            public void run(){
                ...
                car.update(accelerating, braking);
